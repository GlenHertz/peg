...
extern tyProc_9bXer9a4ps9aSGctILcxWReVw Dl_214830_;
extern tyProc_aO673xGTLLxou7P7GxoCXA Dl_214835_;
extern tyProc_im9buRnIvptJfzdASYMEbBA Dl_215001_;
...
extern tyProc_9cu0cWy2jNXKVhds9cs4T9a9cA Dl_215632_;
extern tyProc_hayl9b1HhJokJ1Zo9ctoglPg Dl_215634_;
extern tyProc_IwsYs9blTXXmAlfsBWq604w Dl_215018_;
...
N_NIMCALL(NimStringDesc*, nososErrorMsg)(void) {
	...
	nimln_(25, "oserr.nim");
	{
		...
		nimln_(28, "oserr.nim");
		{
			...
			nimln_(28, "oserr.nim");
			T7_ = (NI32)0;
			T7_ = Dl_214835_(((NI32) 5119), NIM_NIL, err, ((NI32) 0), ((void*) (&msgbuf)), ((NI32) 0), NIM_NIL);
...
N_NIMCALL(NimStringDesc*, osErrorMsg_yWvWz5V6Ib7QshcAbOiDeQ)(NI32 errorCode) {
	...
	nimln_(80, "oserr.nim");
	{
		...
		nimln_(83, "oserr.nim");
		{
			...
			nimln_(83, "oserr.nim");
			T7_ = (NI32)0;
			T7_ = Dl_214835_(((NI32) 4864), NIM_NIL, errorCode, ((NI32) 0), ((void*) (&msgbuf)), ((NI32) 0), NIM_NIL);
			if (!!((T7_ == ((NI32) 0)))) goto LA8_;
			nimln_(85, "oserr.nim");
			result = dollar__D2o4ABrO3iHTudww2CqX4w(msgbuf);
			nimln_(86, "oserr.nim");
