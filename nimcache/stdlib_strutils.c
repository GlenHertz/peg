...
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_6, "0123456789ABCDEF", 16);
	...
	result = mnewString(((NI) (len)));
	{
		...
		res = ((NI) (colontmp_));
		{
			while (1) {
				...
				j = ((NI) (res));
				result->data[j] = ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_6)->data[(NI64)(n & IL64(15))];
...
N_NIMCALL(NimStringDesc*, nsuToLowerAsciiStr)(NimStringDesc* s) {
	...
	result = mnewString(((NI)chckRange((s ? s->Sup.len : 0), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		...
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_8 = subInt((s ? s->Sup.len : 0), ((NI) 1));
		colontmp_ = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_8);
		...
		res = ((NI) 0);
		{
			...
			while (1) {
				...
				TM_JGc9b9bh2D3nTdUR7TGyq8aA_9 = addInt(res, ((NI) 1));
				res = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_9);
			} LA3: ;
		}
	}
	popFrame();
...
{	result = (NI)0;
	...
	m = (((a ? a->Sup.len : 0) <= (b ? b->Sup.len : 0)) ? (a ? a->Sup.len : 0) : (b ? b->Sup.len : 0));
	{
		...
		while (1) {
			...
			TM_JGc9b9bh2D3nTdUR7TGyq8aA_10 = subInt(((NI) (((NU8)(T3_)))), ((NI) (((NU8)(T4_)))));
	...
	TM_JGc9b9bh2D3nTdUR7TGyq8aA_12 = subInt((a ? a->Sup.len : 0), (b ? b->Sup.len : 0));
	result = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_12);
	}BeforeRet_: ;
	popFrame();
	return result;
}
